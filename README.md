...
This repository hosts the public website and collaborative workspace for Innovation Summit 2025 Group 2. Use it to:

1. Publish project updates, visuals, and documentation through the MkDocs site in `docs/`.
2. Share reproducible code, workflows, and lightweight datasets with teammates.

Need to revisit the original template checklist? Keep [TEMPLATE_GUIDE.md](TEMPLATE_GUIDE.md) handy for future reference, but all core names and links in this copy now reflect the Stressors ODFI project.
...
1. Visit your repository link (for this project: `https://github.com/CU-ESIIL/stressors-order-duration-frequency-intensity-innovation-summit-2025__2`).
