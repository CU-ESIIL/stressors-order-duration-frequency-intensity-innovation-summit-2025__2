...
- Add your names to **[Team](https://cu-esiil.github.io/stressors-order-duration-frequency-intensity-innovation-summit-2025__2/#team)** (top nav → Team). Edit the table, keep it simple.
...
git clone https://github.com/CU-ESIIL/stressors-order-duration-frequency-intensity-innovation-summit-2025__2.git
cd stressors-order-duration-frequency-intensity-innovation-summit-2025__2
```
